...
{
    public partial class ShowOriginalImage : Form
    {
       
        public ShowOriginalImage(Bitmap bmp)
        {
            InitializeComponent();
            BigImage = bmp;
        ...
        private void pictureBox1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (picboxxby <= xby)
            {
                ...
                locationy = ((int)((e.Y - ((1.000 / picboxxby) - (1.000 / xby)) * (double)pictureBox1.Width / 2.000) / ((1.000 / xby) * (double)pictureBox1.Width) * (double)BigImage.Height));
            }
            else
            {
                locationx = ((int)((e.X - (picboxxby - xby) * (double)pictureBox1.Height / 2.000) / (xby * (double)pictureBox1.Height) * (double)BigImage.Width));
